...
type LongGreetResponse struct {
	Retult               string   `protobuf:"bytes,1,opt,name=retult,proto3" json:"retult,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LongGreetResponse) GetRetult() string {
	if m != nil {
		return m.Retult
	}
	return ""
...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	0xe7, 0xa5, 0x93, 0xef, 0x43, 0x6d, 0x2e, 0x41, 0x24, 0x03, 0x90, 0x6d, 0x2b, 0x41, 0xb1, 0x0d,
	0xc4, 0x33, 0xba, 0xcd, 0x08, 0x0d, 0xcc, 0xe0, 0xd4, 0xa2, 0xb2, 0xcc, 0xe4, 0x54, 0x21, 0x13,
	0x2e, 0x56, 0x30, 0x5f, 0x48, 0x18, 0xd9, 0x06, 0xa8, 0x43, 0xa4, 0x44, 0x50, 0x05, 0x21, 0x86,
	0x2b, 0x31, 0x08, 0x05, 0x72, 0xf1, 0xa1, 0x7a, 0x53, 0x48, 0x06, 0x59, 0x25, 0x7a, 0x18, 0x4a,
	0xc9, 0xe2, 0x90, 0x85, 0x19, 0x68, 0xc0, 0x28, 0xe4, 0xc4, 0xc5, 0x09, 0xf7, 0x86, 0x90, 0x38,
	0x54, 0x3d, 0x7a, 0xc8, 0x48, 0x49, 0x60, 0x4a, 0xc0, 0xcc, 0xd0, 0x60, 0x74, 0xe2, 0x8c, 0x62,
	0x87, 0xa6, 0xc7, 0x24, 0x36, 0x70, 0x52, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x9e, 0xcb,
	0xf9, 0x0a, 0xa7, 0x02, 0x00, 0x00,
}
